...
@section('title', isset($project['meta']['title']) ? "{$project['meta']['title']} | Edit project" : "Edit project")
@section('content')
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-3">
        <div class="col-8">
            <a class="d-inline-block align-middle me-2" href="{{ route('projects.index') }}">
                <i class="fa-solid fa-arrow-left"></i>
            </a>
            <h2 class="d-inline-block align-middle m-0">Edit project</h2>
        </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="seo">
                        ...
                        <div class="mb-3">
                            ...
                            >{{ $project['meta']['description'] ?? '' }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            >{{ $project['meta']['keywords'] ?? '' }}</textarea>
                            @error('meta.keywords')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-lg-4 text-end">
                                ...
                                <div class="d-block">
                                    <img src="{{$project['attachment']['path']}}" class="image"
